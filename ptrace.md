# ptrace
2024newstar re 第二周 ptrace
(因为对ptrace知识点不熟，所以贴下来了)
...
son 文件的逻辑 1
![](vx_images/429226690207131.png)

son 文件的逻辑 2
![](vx_images/595273672065307.png)
...
int main()
{
    unsigned char a[] =
	{
	  204, 141,  44, 236, 111, 136, 237, 235,  47, 237, 
